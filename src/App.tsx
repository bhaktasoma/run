...
export default function App() {
  ...
  return <div className="app">
    ...
    {page.kind === "today" ? <TodayPage store={training.store} onSaveEntry={training.upsertEntry} onOpenStrength={() => navigate("strength")} />
      ...
      : page.kind === "progress" ? <ProgressPage store={training.store} onAddBenchmark={training.addBenchmark} onSavePaceGuidance={training.savePaceGuidance} />
