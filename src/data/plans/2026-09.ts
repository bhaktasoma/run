...
const plan: Plan = {
  ...
  beforeWeeks: [
    ...
    {
      paragraphs: ["RPE and recovery choose the pace—not the calendar. The listed ranges are conditional references only when current benchmarks support them; slow down on hills, hot days, or whenever the effort is too high."],
      callout: true,
    },
  ],
  weeks: [
    {
      ...
      days: [
        ...
        { day: "Wednesday", date: "Sep 2", run: "No Run", miles: DASH, pace: DASH, strength: "Heavy Legs", core: DASH, mobility: "15 min" },
        { day: "Thursday", date: "Sep 3", run: "Recovery", miles: "3", pace: "13:30–14:15", strength: DASH, core: "15 min C", mobility: "15 min" },
        { day: "Friday", date: "Sep 4", run: "Rest", miles: DASH, pace: DASH, strength: "Upper Moderate / Rest", core: "15 min D", mobility: "15 min" },
    ...
    },
    {
      ...
      days: [
        ...
        { day: "Wednesday", date: "Sep 9", run: "No Run", miles: DASH, pace: DASH, strength: "Heavy Legs", core: DASH, mobility: "15 min" },
        { day: "Thursday", date: "Sep 10", run: "Recovery", miles: "3", pace: "13:30–14:15", strength: DASH, core: "15 min C", mobility: "15 min" },
        { day: "Friday", date: "Sep 11", run: "Rest", miles: DASH, pace: DASH, strength: "Upper Moderate / Rest", core: "15 min D", mobility: "15 min" },
        { day: "Saturday", date: "Sep 12", run: "Long Run", miles: "9", pace: "12:45–13:30", strength: DASH, core: DASH, mobility: "10 min" },
        { day: "Sunday", date: "Sep 13", run: "Long Hike", miles: "2–3 hr", pace: "Comfortable walking pace; RPE 3–4", strength: "Light Upper", core: DASH, mobility: "10 min" },
      ],
    },
    {
      title: "Week 3",
      ...
      days: [
        ...
        { day: "Tuesday", date: "Sep 15", run: "Hill Repeats: 6×60 sec uphill", miles: "5", pace: "Pace varies by grade; RPE 7–8 uphill", strength: "Light Legs", core: "15 min B", mobility: "10 min" },
        { day: "Wednesday", date: "Sep 16", run: "No Run", miles: DASH, pace: DASH, strength: "Heavy Legs", core: DASH, mobility: "15 min" },
        { day: "Thursday", date: "Sep 17", run: "Recovery", miles: "3", pace: "13:30–14:15", strength: DASH, core: "15 min C", mobility: "15 min" },
        { day: "Friday", date: "Sep 18", run: "Rest", miles: DASH, pace: DASH, strength: "Upper Moderate / Rest", core: "15 min D", mobility: "15 min" },
    ...
    },
    {
      ...
      days: [
        ...
        { day: "Wednesday", date: "Sep 23", run: "No Run", miles: DASH, pace: DASH, strength: "Heavy Legs −20% volume", core: DASH, mobility: "15 min" },
        { day: "Thursday", date: "Sep 24", run: "Recovery", miles: "3", pace: "13:45–14:15", strength: DASH, core: "15 min C", mobility: "15 min" },
        { day: "Friday", date: "Sep 25", run: "Rest", miles: DASH, pace: DASH, strength: "Upper Body / Rest", core: "15 min D", mobility: "15 min" },
        { day: "Saturday", date: "Sep 26", run: "Long Run", miles: "7", pace: "13:00–13:45", strength: DASH, core: DASH, mobility: "10 min" },
        { day: "Sunday", date: "Sep 27", run: "Long Hike", miles: "2–3 hr", pace: "Comfortable walking pace; RPE 3–4", strength: "Light Upper", core: DASH, mobility: "10 min" },
      ],
    },
    {
      title: "Week 5",
      ...
      days: [
        ...
        { day: "Wednesday", date: "Sep 30", run: "No Run", miles: DASH, pace: DASH, strength: "Heavy Legs", core: DASH, mobility: "15 min" },
        { day: "Thursday", date: "Oct 1", run: "Recovery", miles: "3", pace: "13:15–14:00", strength: DASH, core: "15 min C", mobility: "15 min" },
        { day: "Friday", date: "Oct 2", run: "Rest", miles: DASH, pace: DASH, strength: "Upper Moderate / Rest", core: "15 min D", mobility: "15 min" },
    ...
    },
    {
      ...
      table: {
        ...
        rows: [
          ...
          ["Wednesday", "Heavy Legs"], ["Thursday", "None"],
          ["Friday", "Moderate Upper Body / Rest"], ["Saturday", "None"], ["Sunday", "Light Upper Body"],
        ],
      },
