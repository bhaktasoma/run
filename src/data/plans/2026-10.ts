...
const plan: Plan = {
  ...
  priorities: [
    ...
    "Use tempo pace around 11:15–11:45/mi only if current benchmarks support it",
    "Use interval pace around 10:15–10:45/mi only if current benchmarks support it",
  ...
  beforeWeeks: [
    ...
    {
      paragraphs: ["Your 9–10 min/mile goal is still the destination, not today’s training pace. RPE and current benchmarks—not the calendar—determine whether the listed pace references are appropriate."],
      callout: true,
    },
  ],
  weeks: [
    {
      ...
      days: [
        ...
        { day: "Wednesday", date: "Oct 7", run: "Easy", miles: "4", pace: "12:45–13:30", strength: "Heavy Legs", core: DASH, mobility: "10 min" },
        { day: "Thursday", date: "Oct 8", run: "Recovery", miles: "3", pace: "13:30–14:15", strength: DASH, core: "Core C", mobility: "15 min" },
        { day: "Friday", date: "Oct 9", run: "Rest", miles: DASH, pace: DASH, strength: "Upper Moderate / Rest", core: "Core D", mobility: "15 min" },
    ...
    },
    {
      ...
      days: [
        ...
        { day: "Wednesday", date: "Oct 14", run: "Easy", miles: "4", pace: "12:45–13:30", strength: "Heavy Legs", core: DASH, mobility: "10 min" },
        { day: "Thursday", date: "Oct 15", run: "Recovery", miles: "3", pace: "13:30–14:15", strength: DASH, core: "Core C", mobility: "15 min" },
        { day: "Friday", date: "Oct 16", run: "Rest", miles: DASH, pace: DASH, strength: "Upper Moderate / Rest", core: "Core D", mobility: "15 min" },
    ...
    },
    {
      ...
      days: [
        ...
        { day: "Wednesday", date: "Oct 21", run: "Easy", miles: "4", pace: "12:45–13:30", strength: "Heavy Legs", core: DASH, mobility: "10 min" },
        { day: "Thursday", date: "Oct 22", run: "Recovery", miles: "3", pace: "13:30–14:15", strength: DASH, core: "Core C", mobility: "15 min" },
        { day: "Friday", date: "Oct 23", run: "Rest", miles: DASH, pace: DASH, strength: "Upper Moderate / Rest", core: "Core D", mobility: "15 min" },
    ...
    },
    {
      ...
      days: [
        ...
        { day: "Wednesday", date: "Oct 28", run: "Rest", miles: DASH, pace: DASH, strength: "Heavy Legs −20% volume", core: DASH, mobility: "15 min" },
        { day: "Thursday", date: "Oct 29", run: "Recovery", miles: "3", pace: "13:30–14:15", strength: DASH, core: "Core C", mobility: "15 min" },
        { day: "Friday", date: "Oct 30", run: "Rest", miles: DASH, pace: DASH, strength: "Upper Body / Rest", core: "Core D", mobility: "15 min" },
    ...
    },
    {
      ...
      table: {
        ...
        rows: [
          ...
          ["Wednesday", "Heavy Legs", "Main lifts 3–4×6–10; accessories 3×10–15"],
          ["Friday", "Moderate Upper / Rest", "3×10–12 or rest before the long run"],
