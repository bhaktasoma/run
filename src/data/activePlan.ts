...
const buildWeek = (blueprint: WeekBlueprint, index: number): ActiveWeek => {
  ...
  const workouts = recoveryWeek ? [
    ...
    workout(dates[6], "Rest or optional Back + Core + Aesthetics", "strength", 0, "RPE 1–2 or strength RPE 5–6", "After Saturday’s long run: use 30–40 minutes when recovered, 15–20 minutes when somewhat tired, or mobility/rest with pain or heavy fatigue.", { duration: "Optional 15–40 min, recovery-dependent" }),
  ];
